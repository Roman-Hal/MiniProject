    ...
    <div>
      ...
      <section className='content'>
        <h2>What is renewable energy</h2>
          <p id="homeP1">Renewable energy is a natural source of energy that will never run out.</p>
          <p id="homeP2">Wind, the Sun and water are renewable energy sources that can be used to create electricity.</p>
